...
<qgis version="3.30.0-'s-Hertogenbosch" styleCategories="Symbology">
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{fb3f5f4a-f076-4d2d-b8ed-328ce2c84390}">
      <rule symbol="0" filter=" (&quot;modes&quot;  =  'car,ebike,escoot' OR &quot;modes&quot; = 'car,ebike,escoot,walk') AND (&quot;oneway&quot; = 1)" key="{1144d448-8eff-487b-9a08-2a031b7690c3}" label="Car - oneway"/>
      <rule symbol="1" filter=" (&quot;modes&quot;  =  'car,ebike,escoot' OR &quot;modes&quot; = 'car,ebike,escoot,walk') AND (&quot;oneway&quot; = 0)" key="{892e8c00-2be2-4538-bf56-39bec4160caf}" label="Car - twoway"/>
      <rule symbol="2" filter="ELSE" key="{079157f0-0b0e-4b14-bea2-6eea4493b195}" label="Rest"/>
    </rules>
    <symbols>
          ...
          <symbol alpha="1" name="@0@0" force_rhr="0" frame_rate="10" is_animated="0" clip_to_extent="1" type="marker">
            ...
            <layer id="{856c9a7b-1407-4800-8906-bb4f15128aae}" enabled="1" locked="0" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option name="color" value="1,31,255,255" type="QString"/>
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="1,31,255,255" type="QString"/>
      ...
      <symbol alpha="1" name="1" force_rhr="0" frame_rate="10" is_animated="0" clip_to_extent="1" type="line">
        ...
        <layer id="{a111d217-4257-4655-b967-9f5946849d1d}" enabled="1" locked="0" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="1,31,255,255" type="QString"/>
      ...
      <symbol alpha="1" name="2" force_rhr="0" frame_rate="10" is_animated="0" clip_to_extent="1" type="line">
        ...
        <layer id="{21a83c65-43ea-4342-8665-0902bd2cd324}" enabled="1" locked="0" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
